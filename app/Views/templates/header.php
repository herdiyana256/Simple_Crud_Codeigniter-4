...
<head>
    ...
    <title><?= isset($page_title) ? $page_title . " | " : "" ?>CI4 Crud-2023</title>
    <!-- Styles -->
...
<body>
    ...
    <nav class="navbar navbar-dark navbar-expand-lg bg-dark bg-gradient">
        <div class="container">
            <a class="navbar-brand" href="<?= base_url() ?>">USM</a>
            ...
            <a href="https://Portfolio.herdiyanadam.repl.co" target="_blank" class="text-light fw-bold text-decoration-none">HERDIYAN ADAM PUTRA_20300047</a>
